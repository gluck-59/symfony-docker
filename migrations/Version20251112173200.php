...
final class Version20251112173200 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, request_id INT NOT NULL, type TINYINT(1) DEFAULT 0 NOT NULL COMMENT \'0 — работы, 1 — накладные, 2 — (авторазноска) работа, 3 (авторазноска) накладные (авторазноски пока нет)\', sum INT DEFAULT 0 NOT NULL, created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', note VARCHAR(14) DEFAULT NULL, INDEX idx_payment_request (request_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
